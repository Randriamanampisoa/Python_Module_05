...
if __name__ == "__main__":
    ...
    print(f"Trying to validate an invalid list ['a', 42, 'b']: "
          f"{log_proc.validate(['a', 42, 'b'])}")
    print("Test invalid ingestion of int '123456' without prior validation:")
    log_proc.ingest(123456)
